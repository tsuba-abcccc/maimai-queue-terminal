...
[![Version](https://img.shields.io/badge/version-0.5.3-007AFF)](https://github.com/tsuba-abcccc/maimai-queue-terminal/tags)
...
- [0.1.0 至 0.5.3 更新日志](docs/update.md)
...
- 通知可以分别控制队列状态、游玩位置、线上登记与签到、暂缓暂离未到场、机台及营业状态；修改结果会在 App、云端和 QQ Bot 间同步。
...
文件会复制到 `output/apk/maimai-Q-0.5.3-local.apk`。
...
现场终端文件会复制到 `output/apk/maimai-Q-0.5.3-terminal.apk`，不得作为 GitHub 公开 Release 附件。
