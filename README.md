...
[![Version](https://img.shields.io/badge/version-0.6.5-007AFF)](https://github.com/tsuba-abcccc/maimai-queue-terminal/tags)
...
- [0.1.0 至 0.6.5 更新日志](docs/update.md)
...
文件会复制到 `output/apk/maimai-Q-0.6.5-local.apk`。
...
现场终端文件会复制到 `output/apk/maimai-Q-0.6.5-terminal.apk`，不得作为 GitHub 公开 Release 附件。
